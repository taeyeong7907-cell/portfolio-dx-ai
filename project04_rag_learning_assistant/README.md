...
| 기능 | 설명 |
|---|---|
| 문서 기반 질의응답 | 업로드된 문서를 기반으로 답변 생성 |
| 답변 스타일 설정 | 사용자의 목적에 따라 답변 톤과 형식 선택 |
| 예상 질문 생성 | 문서 내용을 기반으로 사용자가 물어볼 만한 질문 제안 |
| 꼬리 질문 추천 | 답변 이후 이어질 수 있는 후속 질문 제안 |
| Streamlit UI | 사용자가 쉽게 접근할 수 있는 웹 인터페이스 구성 |
